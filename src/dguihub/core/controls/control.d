...
*/
module dguihub.core.controls.control;

public import dguihub.core.interfaces.idisposable;
public import dguihub.core.events.controlcodeeventargs;
public import dguihub.core.events.scrolleventargs;
public import dguihub.core.events.mouseeventargs;
public import dguihub.core.events.painteventargs;
public import dguihub.core.events.keyeventargs;
public import dguihub.core.events.event;
public import dguihub.core.windowclass;
public import dguihub.core.message;
public import dguihub.core.charset;
public import dguihub.core.winapi;
public import dguihub.core.exception;
public import dguihub.core.geometry;
public import dguihub.core.collection;
public import dguihub.core.handle;
public import dguihub.core.utils;
public import dguihub.core.tag;
public import dguihub.contextmenu;
...
abstract class Control : Handle!(HWND), IDisposable {
   ...
   public void show() {
      if (this.created) {
         SetWindowPos(this._handle, null, 0, 0, 0, 0,
   ...
   extern (Windows) package static LRESULT msgRouter(HWND hWnd, uint msg,
   ...
   private void create() {
      ...
      createWindowEx(this.getExStyle(), ccp.className, this._text,
            this.getStyle(), this._bounds.x, this._bounds.y,
            this._bounds.width, this._bounds.height, hParent, winCast!(void*)(this));
   ...
   private void setWindowPos(int x, int y, int w, int h,
   ...
   protected void createControlParams(ref CreateControlParams ccp) {
      ...
      WindowClass.register(ccp.className, cstyle, ccp.defaultCursor,
            cast(WNDPROC) /*FIXME may throw*/ &Control.msgRouter);
   }
   ...
   protected void onReflectedMessage(ref Message m) {
      ...
      case WM_CTLCOLOREDIT, WM_CTLCOLORBTN:
         SetBkColor(cast(HDC)m.wParam,
               this.backColor.colorref);
   ...
   protected void wndProc(ref Message m) {
      ...
      case WM_MOUSELEAVE: {
            ...
            scope MouseEventArgs e = new MouseEventArgs(Point(LOWORD(m.lParam),
                  HIWORD(m.lParam)), cast(MouseKeys)m.wParam);
            this.onMouseLeave(e);
      ...
      case WM_LBUTTONUP, WM_MBUTTONUP, WM_RBUTTONUP: {
            ...
            if (m.msg == WM_LBUTTONUP && !Control.hasBit(this._cBits,
                  ControlBits.ownClickMsg) && WindowFromPoint(p.point) == this._handle) {
      ...
      case WM_SETCURSOR: {
            if (cast(HWND)m.wParam == this._handle && this._defaultCursor
                  && cast(LONG)this._defaultCursor.handle != GetClassLongW(this._handle,
                     GCL_HCURSOR)) {
