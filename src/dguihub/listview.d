...
class ListViewItem {
   ...
   @property public final bool checked() {
      if (this._owner && this._owner.created) {
         return cast(bool)((this._owner.sendMessage(LVM_GETITEMSTATE,
               this.index, LVIS_STATEIMAGEMASK) >> 12) - 1);
      }
...
class ListView : OwnerDrawControl {
   ...
   @property public final void fullRowSelect(bool b) {
      ...
      if (this.created) {
         this.sendMessage(LVM_SETEXTENDEDLISTVIEWSTYLE, LVS_EX_FULLROWSELECT,
               b ? LVS_EX_FULLROWSELECT : 0);
      }
   }
   ...
   @property public final void checkBoxes(bool b) {
      ...
      if (this.created) {
         this.sendMessage(LVM_SETEXTENDEDLISTVIEWSTYLE, LVS_EX_CHECKBOXES, b
               ? LVS_EX_CHECKBOXES : 0);
      }
   }
   ...
   public final ListViewColumn addColumn(string txt, int w,
         ColumnTextAlign cta = ColumnTextAlign.left) {
      if (!this._columns) {
               ...
               case LVN_ITEMCHANGED: {
                     if (pNotify.uChanged & LVIF_STATE) {
                        ...
                        if ((changedState & 0x2000) || (changedState & 0x1000)) /* IF Checked || Unchecked THEN */ {
                           scope ListViewItemCheckedEventArgs e = new ListViewItemCheckedEventArgs(
                                 this._items[pNotify.iItem]);
